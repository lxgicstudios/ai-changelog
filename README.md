...
<p align="center">
  ...
  <a href="https://github.com/lxgicstudios/ai-changelog/actions">
...
[![GitHub stars](https://img.shields.io/github/stars/LXGIC-Studios/ai-changelog?style=for-the-badge&logo=github&label=stars)](https://github.com/lxgicstudios/ai-changelog)
[![License: MIT](https://img.shields.io/npm/l/ai-changelog.svg?style=for-the-badge&logo=mit&color=blue)](https://github.com/lxgicstudios/ai-changelog/blob/main/LICENSE)
...
```bash
git clone https://github.com/lxgicstudios/ai-changelog.git
cd ai-changelog
npm install
npm run dev
```
